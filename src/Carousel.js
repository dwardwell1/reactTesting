...
//   const leftIcon = cardIdx === 0 ? "hidden" : "";
//   const rightIcon = cardIdx === total - 1 ? "hidden" : "";
...
//         <i
//           className={`fas fa-chevron-circle-left fa-2x ${leftIcon}`}
//           onClick={goBack}
...
//         />
//         <i
//           className={`fas fa-chevron-circle-right fa-2x ${rightIcon}`}
//           onClick={goForward}
